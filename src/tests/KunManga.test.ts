...
import { KunManga } from '../KunManga/KunManga'

describe('KunManga Tests', function () {


    var wrapper: MadaraAPIWrapper = new MadaraAPIWrapper();
    var source: Madara = new KunManga(cheerio);
     ...
     */
    var mangaId = "perfect-secret-love-the-bad-new-wife-is-a-little-sweet";
    var mangaNumericId = ''
