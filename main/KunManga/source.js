...
Object.defineProperty(exports, "__esModule", { value: true });
exports.KunMangaResponse = exports.SuccessResult = exports.WebHomeViewV3 = exports.AllTitlesViewV2 = exports.AllTitlesGroup = exports.MangaViewer = exports.TitleDetailView = exports.TitleRankingView = exports.UpdatedTitleV2Group = exports.OriginalTitleGroup = exports.UpdatedTitle = exports.Title = exports.KunMangaPage = exports.MangaPage = exports.ErrorResult = exports.Popup = exports.Chapter = exports.UpdateTiming = exports.Language = exports.Action = void 0;
...
let KunMangaPage = class KunMangaPage extends light_1.Message {
};
__decorate([
    light_1.Field.d(1, MangaPage, 'optional', null)
], KunMangaPage.prototype, "page", void 0);
KunMangaPage = __decorate([
    light_1.Type.d('KunMangaPage')
], KunMangaPage);
exports.KunMangaPage = KunMangaPage;
...
__decorate([
    light_1.Field.d(1, KunMangaPage, 'repeated', [])
...
let KunMangaResponse = class KunMangaResponse extends light_1.Message {
};
__decorate([
    light_1.Field.d(1, SuccessResult, 'optional', null)
], KunMangaResponse.prototype, "success", void 0);
__decorate([
    light_1.Field.d(2, ErrorResult, 'optional', null)
], KunMangaResponse.prototype, "error", void 0);
KunMangaResponse = __decorate([
    light_1.Type.d('KunMangaResponse')
], KunMangaResponse);
exports.KunMangaResponse = KunMangaResponse;
...
const KunMangaHelper_1 = require("./KunMangaHelper");
const KunMangaSettings_1 = require("./KunMangaSettings");
const Parser_1 = require("./Parser");
const Utility_1 = require("./Utility");
const KunMangaInterceptor_1 = require("./KunMangaInterceptor");
const interceptors_1 = require("./interceptors");
exports.KunMangaInfo = {
    version: '1.0.1',
    name: 'KunManga',
    description: 'Extension that pulls licensed manga from KunManga.',
    author: 'Seanghost',
    authorWebsite: 'https://github.com/seanghost117',
    icon: 'icon.png',
    contentRating: paperback_extensions_common_1.ContentRating.MATURE,
    websiteBaseURL: KunMangaHelper_1.KunManga_DOMAIN,
    sourceTags: [
        {
            text: 'Notifications',
...
class KunManga extends paperback_extensions_common_1.Source {
    constructor() {
        super(...arguments);
        ...
        this.requestManager = createRequestManager({
            ...
            interceptor: new KunMangaInterceptor_1.KunMangaInterceptor([
    ...
    getMangaShareUrl(mangaId) {
        return `${KunMangaHelper_1.KunManga_DOMAIN}/titles/${mangaId}`;
    }
    getMangaDetails(mangaId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = createRequestObject({
                url: `${KunMangaHelper_1.API_DOMAIN}/title_detail`,
                method: 'GET',
    ...
    getChapterDetails(mangaId, chapterId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const request = createRequestObject({
                    url: new Utility_1.URLBuilder(KunMangaHelper_1.API_DOMAIN)
                        .addPathComponent('manga_viewer')
                        .addQueryParameter('chapter_id', chapterId)
                        .addQueryParameter('split', (yield (0, KunMangaSettings_1.getSplitImages)(this.stateManager)))
                        .addQueryParameter('img_quality', (yield (0, KunMangaSettings_1.getResolution)(this.stateManager))
                        .toLowerCase()
                        .replace(' ', '_'))
                        .buildUrl(),
                    headers: {
                        referer: `${KunMangaHelper_1.KunManga_DOMAIN}/viewer/${chapterId}`
                    },
                    method: 'GET'
                });
                const response = yield this.requestManager.schedule(request, 1);
            ...
            try {
                if (!metadata) {
                    ...
                    if (query.parameters && query.parameters['id'] && query.parameters['id'][0]) {
                        id = query.parameters['id'][0].match(KunMangaHelper_1.ID_REGEX);
                    }
                    if (id && id[0]) {
                    ...
                    const request = createRequestObject({
                        url: `${KunMangaHelper_1.API_DOMAIN}/title_list/allV2`,
                        method: 'GET',
                        headers: {
                            referer: `${KunMangaHelper_1.KunManga_DOMAIN}/manga_list/all`
                        }
                    });
                    const response = yield this.requestManager.schedule(request, 1);
                    const data = createByteArray(response.rawData);
                    const results = this.parser.parseSearchResults(data, yield (0, KunMangaSettings_1.getLanguages)(this.stateManager), query);
                    metadata = {
                        manga: results,
                        offset: 0
                    };
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            const languages = yield (0, KunMangaSettings_1.getLanguages)(this.stateManager);
            const sections = [
                {
                    requests: [createRequestObject(KunMangaHelper_1.PopularRequest)],
                ...
                {
                    requests: [
                        createRequestObject(KunMangaHelper_1.LatestUpdatesRequest),
                        createRequestObject(KunMangaHelper_1.PopularRequest)
                    ],
                    section: createHomeSection({
                        id: 'latest',
            ...
            try {
                if (!metadata) {
                    ...
                    switch (homepageSectionId) {
                        case 'popular': {
                            const requests = [createRequestObject(KunMangaHelper_1.PopularRequest)];
                            const responses = yield Promise.all(requests.map((request) => this.requestManager.schedule(request, 1)));
                            const data = responses.map((response) => createByteArray(response.rawData));
                            results = this.parser.parsePopularSection(data, yield (0, KunMangaSettings_1.getLanguages)(this.stateManager));
                            break;
                        }
                        case 'latest': {
                            const requests = [
                            ...
                            const responses = yield Promise.all(requests.map((request) => this.requestManager.schedule(request, 1)));
                            const data = responses.map((response) => createByteArray(response.rawData));
                            results = this.parser.parseRecentUpdatesSection(data, yield (0, KunMangaSettings_1.getLanguages)(this.stateManager));
                            break;
                        }
                        default:
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return Promise.resolve(createSection({
                ...
                rows: () => Promise.resolve([
                    (0, KunMangaSettings_1.contentSettings)(this.stateManager),
                    (0, KunMangaSettings_1.resetSettings)(this.stateManager)
                ])
            }));
        });
    }
    getCloudflareBypassRequest() {
        return createRequestObject({
            url: `${KunMangaHelper_1.KunManga_DOMAIN}`,
            method: 'GET'
        });
    }
}
...
},{"./KunMangaHelper":90,"./KunMangaInterceptor":91,"./KunMangaSettings":92,"./Parser":93,"./Utility":94,"./interceptors":97,"paperback-extensions-common":15}],90:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.LatestUpdatesRequest = exports.PopularRequest = exports.HEX_GROUP = exports.ID_REGEX = exports.COMPLETE_REGEX = exports.TITLE_THUMBNAIL_PATH = exports.API_DOMAIN = exports.KunManga_DOMAIN = exports.LangCode = exports.TitleList = void 0;
class TitleList {
    static get() {
...
exports.KunManga_DOMAIN = 'https://KunManga.com';
...
exports.PopularRequest = {
    ...
    method: 'GET',
    headers: {
        referer: `${exports.KunManga_DOMAIN}/manga_list/hot`
    }
};
exports.LatestUpdatesRequest = {
    ...
    method: 'GET',
    headers: {
        referer: `${exports.KunManga_DOMAIN}/updates`
    }
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.KunMangaInterceptor = void 0;
const Utility_1 = require("./Utility");
class KunMangaInterceptor {
...
exports.KunMangaInterceptor = KunMangaInterceptor;
                            ...
                            return Promise.all([
                                ...
                                return [
                                    createSelect({
                                        id: 'languages',
                                        label: 'Languages',
                                        options: KunMangaHelper_1.LangCode,
                                        displayLabel: (option) => {
                                            switch (option) {
                                                case 'en':
                                                    return 'English';
...
},{"./KunMangaHelper":90}],93:[function(require,module,exports){
"use strict";
/* eslint-disable @typescript-eslint/ban-ts-comment */
/* eslint-disable no-case-declarations */
/* eslint-disable @typescript-eslint/no-explicit-any */
...
class Parser {
    parseMangaDetails(data, mangaId) {
        const result = APIInterface_1.KunMangaResponse.decode(data);
        ...
        const isCompleted = KunMangaHelper_1.COMPLETE_REGEX.test(details.nonAppearanceInfo);
        return createManga({
            id: mangaId,
    ...
    parseChapterList(data, mangaId) {
        try {
            ...
            return (chapters
                ...
                langCode: KunMangaHelper_1.LangCode[details.title.language],
    ...
    parseSearchResults(data, languages, query) {
        ...
        try {
            ...
            if (result.success.titleDetailView != null) {
                ...
                if (KunMangaHelper_1.LangCode[title.language] && languages.includes((_a = KunMangaHelper_1.LangCode[title.language]) !== null && _a !== void 0 ? _a : 'unknown')) {
                    return [
                        createMangaTile({
                            id: `${title.titleId}`,
                            image: title.portraitImageUrl,
            ...
            KunMangaHelper_1.TitleList.set(result.success.allTitlesViewV2.allTitlesGroup
                .flatMap((allTitlesGroup) => allTitlesGroup.titles)
                .filter((title) => { var _a; return languages.includes((_a = KunMangaHelper_1.LangCode[title.language]) !== null && _a !== void 0 ? _a : 'unknown'); }));
            return KunMangaHelper_1.TitleList.get()
    ...
    parsePopularSection(data, languages) {
        var _a;
        const result = APIInterface_1.KunMangaResponse.decode((_a = data[0]) !== null && _a !== void 0 ? _a : new Uint8Array(0));
        if (result.success == null) {
            const error = result.error.englishPopup.body;
            console.log(error);
            throw new Error(error);
        }
        KunMangaHelper_1.TitleList.set(result.success.titleRankingView.titles.filter((title) => { var _a; return languages.includes((_a = KunMangaHelper_1.LangCode[title.language]) !== null && _a !== void 0 ? _a : 'unknown'); }));
        const titleList = KunMangaHelper_1.TitleList.get();
    ...
    parseRecentUpdatesSection(data, languages) {
        ...
        const popularResult = APIInterface_1.KunMangaResponse.decode((_b = data[1]) !== null && _b !== void 0 ? _b : new Uint8Array(0));
        if (popularResult.success != null) {
            KunMangaHelper_1.TitleList.set(popularResult.success.titleRankingView.titles.filter((title) => { var _a; return languages.includes((_a = KunMangaHelper_1.LangCode[title.language]) !== null && _a !== void 0 ? _a : 'unknown'); }));
        }
...
},{"./APIInterface":88,"./KunMangaHelper":90,"paperback-extensions-common":15}],94:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class ImageInterceptor {
    ...
    decodeImage(encryptionKey, image) {
        const streamSplit = encryptionKey.match(KunMangaHelper_1.HEX_GROUP);
        if (streamSplit == null)
...
},{"../KunMangaHelper":90}],96:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
class ThumbnailInterceptor {
    ...
    interceptResponse(response) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isBadCode && url.includes(KunMangaHelper_1.TITLE_THUMBNAIL_PATH)) {
                const titleId = parseInt((_b = (_a = url.split(`/${KunMangaHelper_1.TITLE_THUMBNAIL_PATH}`)[0]) === null || _a === void 0 ? void 0 : _a.split('/').pop()) !== null && _b !== void 0 ? _b : '');
                const title = KunMangaHelper_1.TitleList.get().find((title) => title.titleId == titleId);
                if (!title)
                    return response;
                const request = createRequestObject({
...
},{"../KunMangaHelper":90}],97:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
